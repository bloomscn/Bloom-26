import type { SectionIntro, SocialLink } from "../types/content";

export const contactIntro: SectionIntro = {
  label: "Contact Us",
  heading: "Let's create impact together",
  description:
    "Whether you're interested in donating, partnering, or simply learning more about Bloom '26, we'd love to hear from you.",
};
...
export const contactInfo = {
  ...
  whatsappButtonLabel: "Start on WhatsApp",
};
...
export const socialLinks: SocialLink[] = [
  ...
  { label: "X", href: "https://x.com/aieseclk" },
];
